...
# borrowed phone should not be able to empty somebody's session, and six
# digits is a small price at the point of doing it.
#
# Most of them land on other people. `desk` is the odd one and the most
