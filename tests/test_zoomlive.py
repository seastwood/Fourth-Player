"""The pad getting out of a zoomed picture way, in a real browser.

Geometry rather than stylesheet: a rule can be present and beaten by
specificity, by a media query that does not match, or by a position further
down the file. All three have happened in this stylesheet.
"""
import os
import shutil
import subprocess
...
try:
    ...
    result = subprocess.run(
        [node, os.path.join(HERE, "browser", "zoomlive.mjs")],
